...
const backgroundPrimary = "#efeff4";
const primaryBlue = "#22BAAE";
const borderColor = "#fff";
const primaryTextColor = "#444444";
const smallTextColor = "#B2C3DB";
const primaryRed = "#22BAAE";
const {
  headerFontSize,
...
export default StyleSheet.create({
  ...
  cardMeta: { padding: 5 },
  cardTitle: { marginBottom: 20, fontSize: 18 },
  cardProfile: { width: 20, height: 20, borderRadius: 10 },
  cardProfileTitle: { fontSize: 16 },
  topBar: {
    margin: 10,
    marginTop: 40,
  },
